...
**本地更新版本：`2026.09.04-state-tracker` · 连续棋局状态跟踪 · Windows x64 单 EXE 免安装版**
...
本版验证包括全部通过的 170 项源码回归测试和 106 项单 EXE 集成断言；成品通过 14 组内置功能自检。新增概率证据、遮挡降权、合法候选排序、快回复、事务不可重复点击、连续抓屏回退、光流平移和诊断限额检查。接管检查使用模拟 Win32 接口，不会点击真实棋盘；这些结果不等于已在所有游戏客户端或其他电脑上验证。详细范围见[连续棋局状态跟踪版发布说明](docs/releases/v2026.09.04-state-tracker.md)，旧版见[流畅界面与自动执棋版发布说明](docs/releases/v2026.08.31-smooth-ui-autoside.md)、[界面优化版发布说明](docs/releases/v2026.08.31-ui.md)与[免安装版发布说明](docs/releases/v2026.08.31-portable.md)。
